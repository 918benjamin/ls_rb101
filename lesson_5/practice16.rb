...
The numberof possible UUID values is approximately 3.4 X 10E38.
...
HEX_CHARS = '1234567890abcdef'.chars

def uuid
  uuid_arr = []
  32.times do
    uuid_arr << HEX_CHARS.sample
  end
  uuid_str = ""
  uuid_helper(uuid_str, uuid_arr, 8)
  uuid_helper(uuid_str, uuid_arr, 4)
  uuid_helper(uuid_str, uuid_arr, 4)
  uuid_helper(uuid_str, uuid_arr, 4)
  uuid_helper(uuid_str, uuid_arr, 12, false)
  p uuid_str
end

def uuid_helper(uuid_str, uuid_arr, num, dash=true)
  num.times do
    uuid_str << uuid_arr.shift
  end
